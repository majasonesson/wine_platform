    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.buttons}>
          <NavLink to='/producer/profile/edit' className={styles.btnProfile}>
            {translatedText['Edit']}
        ...
        <div className={styles.certifications}>
          ...
          <div className={styles.certContainer}>
            {certificationOptions.map((certOption, index) => {
              const userCert = userData.certifications.find(
                ...
                <div className={styles.boxShadow} key={index}>
                  ...
                  <div className={styles.certDetails}>
                    <div className={styles.certDate}>
                      {translatedText['Expiry Date']}:<br></br>
                      <br></br>
                      {new Date(userCert.expiryDate).toLocaleDateString()}
                    </div>
                    <p className={styles.ref}>
                      {translatedText['Ref Number']}: {userCert.referenceNumber}
                    </p>
                  </div>
                </div>
              ) : null;
            ...
            {userData.certifications.length === 1 && (
              <div className={styles.singleCertText}>
                {userData.certifications[0].type === 'SQNPI' &&
                  translatedText['SQPNI']}
                {userData.certifications[0].type === 'KRAV' &&
                  translatedText['KRAV']}
                {userData.certifications[0].type === 'EU_ORGANIC' &&
                  translatedText['EU_ORGANIC']}
              </div>
            )}
          </div>
        </div>
