...
import { changeImporterSubscription } from '../../../../../Services/stripe';
...
const ImporterChangePlan = () => {
  ...
  const handleSubscription = async (priceId) => {
    try {
      ...
      const response = await changeImporterSubscription(priceId, userId);
        ...
        <div className={styles.pricesSection}>
          ...
          <div className={styles.priceCards}>
            ...
            <div className={styles.priceCard}>
              <h4 className={styles.labelCount}>3 Producers</h4>
            ...
            {/* Basic Plan */}
            <div className={styles.priceCard}>
              <h4 className={styles.labelCount}>15 Producers</h4>
            ...
            {/* Standard Plan */}
            <div className={styles.priceCard}>
              <h4 className={styles.labelCount}>30 Producers</h4>
            ...
            {/* Premium Plan */}
            <div className={styles.priceCard}>
              <h4 className={styles.labelCount}>50 Producers</h4>
...
export default ImporterChangePlan;
