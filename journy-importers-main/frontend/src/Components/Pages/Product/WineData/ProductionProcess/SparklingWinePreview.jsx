import styles from './sparklingWinePreview.module.scss';

export const SparklingWinePreview = ({ wineData, translatedText }) => {
    ...
    <div className={styles.productionItem}>
      ...
      <div className={styles.processDetail}>
        <span className={styles.itemText}>
          {translatedText[value] || formatText(value)} {translatedText[suffix]}
        </span>
      </div>
    </div>
  );
